...
g_density: g_density.c gmx_density.o makefile
	$(CC) $(PROFILE) $(TP) -DNO_ALPHA $(VALGRIND) $(DEBUG) $(OPT)  -L$(HOME)/lib/ -DHAVE_CONFIG_H -I. $(ALPHA_INCLUDE) -I$(GROMACS)/include -I$(GROMACS)/src -I/usr/include/libxml2     -I./include  -o g_density gmx_density.o $(ALPHA_LIB) -ldl  -lgmx -lm  g_density.c 
