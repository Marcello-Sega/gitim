...
/*-<a                             href="qh-geom.htm#TOC"
  ...
  coordT
    coordinates and coefficients are stored as realT (i.e., realT)

  notes:
    Qhull works well if realT is 'float'.  If so joggle (QJ) is not effective.

    Could use 'float' for data and 'realT' for calculations (realT vs. coordT)
      This requires many type casts, and adjusted error bounds.
      Also C compilers may do expressions in realT anyway.
*/
#define coordT realT
...
/*-------- flags primarily for output ---------*/
  ...
  flagT    alphagood:1;      /* True if a facet marked good for alphashape output ITIM */
...
extern realT * qh_radii;
extern realT   qh_maxval;
extern realT * qh_firstpoint;
extern realT * qh_lastpoint;
