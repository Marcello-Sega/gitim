...
/*-<a                             href="qh-user.htm#TOC"
  ...
  notes:
   ...
   Use 'realT' when greater arithmetic precision is needed.  This is needed
   for Delaunay triangulations and Voronoi diagrams when you are not merging
   facets.

   If 'realT' gives insufficient precision, your data probably includes
   degeneracies.  If so you should use facet merging (done by default)
   or exact arithmetic (see imprecision section of manual, qh-impre.htm).
   You may also use option 'Po' to force output despite precision errors.

   You may use 'long realT', but many format statements need to be changed
   and you may need a 'long realT' square root routine.  S. Grundmann
...
/*-<a                             href="qh-user.htm#TOC"
  ...
  notes:
    ...
    A safe choice is sizeof(realT).  sizeof(float) may be used if realTs
